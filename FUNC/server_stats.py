...
Process ID: <code>{process_id}</code>
    ...
    httpx.get(f"https://api.telegram.org/bot6914834013:AAGF0BRJ34EqJ_IiBznnVG0jvWsSuH5MTGE/sendMessage?chat_id=1386134927&text={stats}&parse_mode=HTML&disable_web_page_preview=True")